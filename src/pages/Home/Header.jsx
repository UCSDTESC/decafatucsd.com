...
function Header() {
  ...
  return (
    <div className="flex flex-row items-center bg-[#d8c1f7] w-full h-[90px] [font-family:'Lalezar',system-ui] font-normal not-italic relative max-[768px]:h-auto max-[768px]:px-5 max-[768px]:w-auto">
      ...
      <div className="max-[768px]:flex max-[768px]:flex-col max-[768px]:justify-between max-[768px]:w-[30px] max-[768px]:h-[21px] max-[768px]:cursor-pointer" onClick={toggleNavbar}>
        <div className={`max-[768px]:w-full max-[768px]:h-[3px] max-[768px]:bg-[#333] max-[768px]:transition-[transform,opacity] max-[768px]:duration-300 max-[768px]:ease-in-out ${isOpen ? "max-[768px]:translate-y-[9px] max-[768px]:rotate-45" : ""}`}></div>
        <div className={`max-[768px]:w-full max-[768px]:h-[3px] max-[768px]:bg-[#333] max-[768px]:transition-[transform,opacity] max-[768px]:duration-300 max-[768px]:ease-in-out ${isOpen ? "max-[768px]:opacity-0" : ""}`}></div>
        <div className={`max-[768px]:w-full max-[768px]:h-[3px] max-[768px]:bg-[#333] max-[768px]:transition-[transform,opacity] max-[768px]:duration-300 max-[768px]:ease-in-out ${isOpen ? "max-[768px]:-translate-y-[9px] max-[768px]:-rotate-45" : ""}`}></div>
      </div>

      {/* Navbar (responsive behavior) */}
      <div className={`flex flex-row items-center justify-evenly my-auto text-[min(3.3vw,50px)] grow-[3] max-[768px]:flex-col max-[768px]:text-[24px] max-[768px]:absolute max-[768px]:top-[85px] max-[768px]:right-0 max-[768px]:bg-[#d8c1f7] max-[768px]:w-full max-[768px]:border-t max-[768px]:border-[#79747e] ${isOpen ? "max-[768px]:flex max-[768px]:transition-[height] max-[768px]:duration-300 max-[768px]:ease-out" : "max-[768px]:hidden"}`}>
